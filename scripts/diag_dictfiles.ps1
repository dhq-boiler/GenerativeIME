...
$files = 'SKK-JISYO.L.utf8','SKK-JISYO.godan.utf8','SKK-JISYO.conjugations.utf8','SKK-JISYO.propernouns.utf8','SKK-JISYO.emoji.utf8','SKK-JISYO.loanwords.utf8','mecab.dll'
foreach ($f in $files) {
  $p = Join-Path $dir $f
  if (Test-Path $p) {
